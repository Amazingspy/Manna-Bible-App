    ...
    return (
        <View className="flex-1">
            ...
            <ImageBackground
                ...
                resizeMode="cover"
            >
                {/* Elegant Overlay (Replaced LinearGradient) */}
                <View className="flex-1 bg-black/40">
                    <SafeAreaView className="flex-1 px-8 py-12">
                        {/* Branding Section */}
                        <View className="flex-1 items-center justify-center">
                            <View className="mb-6 h-24 w-24 items-center justify-center rounded-[2.5rem] bg-white/10 backdrop-blur-3xl ring-1 ring-white/20">
                                <MaterialIcons name="bakery-dining" size={56} color="#FFD700" />
                            </View>
                        ...
                        <View className="gap-4 w-full">
                            <TouchableOpacity
                                ...
                                activeOpacity={0.6}
                                className="h-16 w-full items-center justify-center overflow-hidden rounded-2xl bg-[#1b365c] shadow-2xl active:scale-95"
                            >
                                <Text className="text-lg font-bold tracking-tight text-white">Get Started</Text>
                            </TouchableOpacity>

                            <TouchableOpacity
                                className="h-16 w-full items-center justify-center rounded-2xl border border-white/60 bg-white active:scale-95"
                                activeOpacity={0.6}>
