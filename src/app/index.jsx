                ...
                <View className="flex-1 bg-black/40">
                    <SafeAreaView className="flex-1 px-8 py-12">
                        ...
                        <View className="gap-4 w-full">
                            ...
                            >
                                <Text className="text-lg font-bold tracking-tight text-slate-900 uppercase">Create Account</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.6}>
                                <Text className="text-lg font-bold text-white uppercase">Sign In</Text>
                            </TouchableOpacity>
                        </View>
